...
SECRET_KEY = 'django-insecure-p7c+70%&+i2m#+#x_^cq%@8)v2)-d8!af^%3j4o55ys(+m@e-3'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'dashboard.context_processors.notification_data',
                'systemAdmin.admin_context_processors.notification_data',
            ],
        },
    },
]
